		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "customersFlex",
									"targetURL": "#comproycustomersflex-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comproycustomersflex-display": {
								"semanticObject": "comproycustomersflex",
								"action": "display",
								"description": "customersFlex",
								"title": "customersFlex",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.proy.customersflex",
									"url": sap.ui.require.toUrl("com/proy/customersflex")
								}
							}
						}
					}
